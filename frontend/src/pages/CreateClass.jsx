    ...
    <Stack
      ...
      >
        <Paper sx={{ padding: "30px", width: 500, maxHeight: 500 }}>
          ...
          <Typography variant="h7">Tạo lớp học của bạn để chia sẻ những bộ flashcard chất lượng cho học viên.</Typography>
          <br />
          <form onSubmit={handleSubmit(createClass)} noValidate>
            <Stack flexDirection={"column"} sx={{gap:'20px', mt:"40px" }}>
              ...
              >
                <Button disabled={!isDirty||loading} type="submit" variant="contained">
                  Tạo lớp học
                </Button>
                <Button
                  color="error"
