...
const ChangePass = () => {
  ...
  return (
    <>
        <Navbar/>
        <Stack sx={{ height:"calc(100vh - 64px)", flexDirection:"row", justifyContent:"space-evenly", backgroundColor:"rgba(0,0,0,0.05)"}}>
            <Box flex={2} sx={{p:3}}>
                <List sx={{
                    backgroundColor:"#fff",
                    borderRadius:"8px",
            ...
            <Box flex={8} sx={{p:3, display:"flex", justifyContent: "center"}} >
                <Box sx={{
                    ...
                    <Typography variant='h5' textAlign="left" mb={2}>Đổi mật khẩu</Typography>
                    <form noValidate onSubmit={handleSubmit(onSubmit)}>
                        <Stack spacing={2} >
                            ...
                            <TextField
                                ...
                                variant="standard"
                            />
                            <Button type='submit' disabled={!isDirty}>Đổi mật khẩu</Button>
                        </Stack>
                    </form>
                </Box>
            </Box>
