    ...
    <LayoutNormal>
      <Stack sx={{justifyContent:"center", alignItems:"center", width:"100%", height:"100%"}}>
        <Paper sx={{ padding:"30px",width:500, maxHeight:500}}>
          <Typography variant="h5" >Tạo bộ mới</Typography><br/>
            <form onSubmit={handleSubmit(createSet)} noValidate>
              ...
              <Stack flexDirection={'row'} sx={{gap:"50px", width:"100%"}}>
                <FormControl>
                    ...
                    <Controller
                      ...
                      defaultValue={1}
                      render={({ field }) => (
                        <Select {...field} variant='standard' id="typeSet" sx={{width:"150px",mt:10,fontSize:"18px"}}>
                ...
                <FormControl flex={1}>
                    ...
                    <Controller
                      ...
                      defaultValue={false}
                      render={({ field }) => (
                        <Select {...field} variant='standard' id="isPrivate" sx={{width:"150%",mt:10,fontSize:"18px"}}>
              ...
              <Stack sx={{flexDirection:"row",justifyContent:"space-between",marginTop:"30px", width:"100%"}}>
                <Button disabled={!isDirty} type='submit' variant='contained'>Tạo</Button>
                <Button color='error' type='button' variant='contained' onClick={()=>{navigate(-1)}}>Huỷ</Button>
              </Stack>
              </Stack>
            </form>
        </Paper>
