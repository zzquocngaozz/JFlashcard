export const role = {
  ...
  password: {
    ...
    pattern: {
      ...
      message:
        "Mật khẩu phải có từ 8 ký tự chỉ bao gồm chữ hoa, chữ thường và chữ số",
    },
  },
  fullname: {
    ...
    pattern: {
      value:
        /^[^\s!@#$%^&*()_+{}\[\]:;<>,.?~\|\/\-][^!@#$%^&*()_+{}\[\]:;<>,.?~\\\|\/\-]*[^\s!@#$%^&*()_+{}\[\]:;<>,.?~\\\|\/\-]$/,
      message:
        "Họ và tên không được chứa những ký tự đặc biệt và ký tự trắng thừa",
    },
  },
  firstName: {
  ...
  className: {
    ...
    minLength: {
      value: 2,
      message: "Tên lớp học phải nhiều hơn hoặc bằng 2 kí tự",
    },
    maxLength: {
      value: 50,
      message: "Bạn không nên để tên lớp quá dài! Tối đa 50 ký tự",
    },
    pattern: {
      value: /^[^\s][^&@]*$/gim,
      message: "Tên lớp không chứa dấu cách ở đầu",
    },
  },
  description: {
    maxLength: {
