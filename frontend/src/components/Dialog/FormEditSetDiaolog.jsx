    ...
    <>
      <Dialog open={true} onClose={handleToggleUpdateSet}>
        <form noValidate onSubmit={handleSubmit(updateSet)}>
             ...
             />
              <FormControl flex={1}>
                     ...
                     <Controller
                       ...
                       render={({ field }) => (
                         <Select {...field} variant='standard' id="private" sx={{width:"150px",mt:10,fontSize:"18px"}}>
          ...
          <DialogActions>
            <Button type='button' onClick={handleToggleUpdateSet} variant='contained' color='error'>Huỷ</Button>
            <Button type='submit' disabled={!isDirty} variant='contained'>Cập nhật</Button>
          </DialogActions>
        </form>
      </Dialog>
    </>
