...
INSERT INTO `db_jflashcards`.`flashcard_set` (`created_at`, `description`, `isprivate`, `title`, `type`, `user`)
VALUES
...
INSERT INTO `db_jflashcards`.`chat_message` (`content`, `is_read`, `timestamp`, `class_id`, `recipient`, `sender`)
VALUES
...
INSERT INTO `db_jflashcards`.`class_member` (`class_id`, `user_id`)
VALUES
    (1, 1),
    (1, 2);
...
INSERT INTO `db_jflashcards`.`class_set` (`created_at`, `due_at`, `class_id`, `set_id`)
VALUES
...
INSERT INTO `db_jflashcards`.`folder_set` (`created_at`, `description`, `title`, `user_id`)
VALUES
...
INSERT INTO `db_jflashcards`.`folder_Set_flashcard_Set` (`folder_id`, `flashcard_set_Id`)
VALUES
    (1, 1),
    (2, 2);
...
INSERT INTO `db_jflashcards`.`user_log` (`created_at`, `description`, `log_at`, `user_id`)
VALUES
...
INSERT INTO `db_jflashcards`.`user_request` (`create_at`, `expire_at`, `request_type`, `token`, `user_id`)
VALUES
